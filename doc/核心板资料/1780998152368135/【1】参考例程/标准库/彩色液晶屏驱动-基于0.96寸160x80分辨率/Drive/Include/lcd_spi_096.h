...
#define 	GPIO_LCD_CS_CLK     			RCC_AHB1Periph_GPIOA				// CS引脚IO口时钟
...
#define 	LCD_Backlight_ON    	GPIO_ResetBits(LCD_Backlight_PORT,LCD_Backlight_PIN)	// 低电平，开启背光
#define 	LCD_Backlight_OFF  	GPIO_SetBits(LCD_Backlight_PORT,LCD_Backlight_PIN)		// 高电平，关闭背光
